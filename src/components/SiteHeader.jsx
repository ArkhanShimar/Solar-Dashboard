function SiteHeader({ siteInfo }) {
  ...
  return (
    <header className="overflow-hidden rounded-2xl border border-white bg-parchment-50 shadow-card">
      ...
      <div className="flex flex-col gap-4 px-4 py-3.5 md:flex-row md:items-center md:justify-between md:px-5 md:py-3.5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-5 rounded-xl bg-white px-4 py-2 ring-1 ring-parchment-200">
            <div>
          ...
          <span className="inline-flex items-center gap-2 rounded-full bg-moss-500/10 px-3 py-1.5 text-sm font-bold text-moss-600 ring-1 ring-moss-400/40">
